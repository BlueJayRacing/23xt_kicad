...
As a summary, you should be using **KiCad Version 10.0**. All project will be modular, and you should be storing all your step files, symbols, & footprints within the created folders.
